      ...
      <div className="min-h-[70vh] flex items-center justify-center p-6">
        <div className="bg-white rounded-3xl border border-slate-200 p-8 max-w-md w-full text-center shadow-xl">
          ...
          <p className="text-xs text-slate-500 mb-6 leading-relaxed">
            หน้านี้สงวนไว้สำหรับผู้ดูแลระบบ (Admin) เท่านั้น คุณสามารถกดเข้าสู่ระบบด้วยบัญชี Admin สาธิตเพื่อทดสอบระบบได้ทันที
          </p>
          <div className="flex flex-col gap-3">
            <button
              onClick={onOpenAuth}
              className="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-xs font-bold transition-colors shadow-xs flex items-center justify-center gap-2"
            >
