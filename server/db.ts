...
class DatabaseStore {
  ...
  private loadOrSeed(): DatabaseSchema {
    ...
    if (fs.existsSync(DB_FILE)) {
      try {
        ...
        // Auto-merge new seed activities if missing
        const seed = this.generateSeedData();
        let changed = false;
        if (Array.isArray(parsed.activities)) {
          const existingIds = new Set(parsed.activities.map((a: any) => a.id));
          for (const sAct of seed.activities) {
            if (!existingIds.has(sAct.id)) {
              parsed.activities.push(sAct);
              changed = true;
            }
          }
        } else {
          parsed.activities = seed.activities;
          changed = true;
        }
  ...
  private generateSeedData(): DatabaseSchema {
    ...
    const activities: Activity[] = [
      ...
      {
        id: 'act-13',
        title: 'Daily Journaling & Gratitude Practice',
        titleTh: 'เขียนบันทึกความรู้สึกและขอบคุณประจำวัน',
        categoryId: 'cat-learning',
        description: 'จดบันทึก 3 สิ่งที่รู้สึกขอบคุณในวันนี้ พร้อมสะท้อนความรู้สึกเพื่อฝึกจิตใจให้แจ่มใสและมีสติ',
        durationMinutes: 15,
        energyLevel: 'low',
        equipment: ['สมุดไดอารี่หรือแอปบันทึก', 'ปากกาหมึกซึมคู่ใจ', 'เครื่องดื่มอุ่นๆ'],
        steps: [
          { step: 1, title: 'สงบนิ่งและนึกถึงเหตุการณ์ในวัน', instruction: 'ทบทวนเหตุการณ์ดีๆ ที่เกิดขึ้นตั้งแต่เช้า', durationMinutes: 3 },
          { step: 2, title: 'เขียน 3 สิ่งที่รู้สึกขอบคุณ', instruction: 'ระบุรายละเอียดเล็กๆ ที่ทำให้ยิ้มได้', durationMinutes: 7 },
          { step: 3, title: 'ตั้งเป้าหมาย 1 อย่างสำหรับวันพรุ่งนี้', instruction: 'เขียนเจตจำนงเชิงบวกสั้นๆ 1 ประโยค', durationMinutes: 5 },
        ],
        isActive: true,
      ...
      {
        id: 'act-14',
        title: 'Core Workout & Plank Challenge',
        titleTh: 'ออกกำลังกายแกนกลางลำตัวและแพลงก์',
        categoryId: 'cat-health',
        description: 'ฝึกความแข็งแรงของกล้ามเนื้อหน้าท้องและหลังส่วนล่าง เสริมบุคลิกภาพที่ดีและลดอาการปวดหลัง',
        durationMinutes: 20,
        energyLevel: 'high',
        equipment: ['เสื่อออกกำลังกาย', 'นาฬิกาจับเวลา', 'น้ำดื่มสะอาด'],
        steps: [
          { step: 1, title: 'วอร์มอัพข้อต่อและยืดเส้น', instruction: 'หมุนหัวไหล่ ขยับสะโพก และทำ Cat-Cow 2 นาที', durationMinutes: 3 },
          { step: 2, title: 'ฝึกเซ็ตแพลงก์และครันช์', instruction: 'แพลงก์ 45 วินาที x 3 เซ็ต สลับกับ Bird-Dog และ Side Plank', durationMinutes: 14 },
          { step: 3, title: 'คูลดาวน์ยืดหลัง', instruction: 'ยืดเหยียดท่า Child’s Pose และ Cobra Pose หายใจลึกๆ', durationMinutes: 3 },
        ],
        isActive: true,
        createdAt: new Date(Date.now() - 3 * 86400000).toISOString(),
        updatedAt: new Date().toISOString(),
      ...
      {
        id: 'act-15',
        title: 'Artisan Pour-Over Drip Coffee',
        titleTh: 'ดริปกาแฟสดสไตล์ Slow Bar รื่นรมย์',
        categoryId: 'cat-cooking',
        description: 'สัมผัสศิลปะการชงกาแฟดริป ค่อยๆ ควบคุมสายน้ำ ดมกลิ่นหอมของเมล็ดกาแฟคั่วบด สดชื่นตื่นตัว',
        durationMinutes: 20,
        energyLevel: 'low',
        equipment: ['เมล็ดกาแฟ Specialty', 'เครื่องบดมือ', 'ดริปเปอร์และกระดาษกรอง', 'กาน้ำดริปคอห่าน'],
        steps: [
          { step: 1, title: 'บดเมล็ดกาแฟและพับกระดาษกรอง', instruction: 'บดกาแฟขนาดปานกลาง รินน้ำร้อนล้างกระดาษกรองทิ้งก่อน', durationMinutes: 5 },
          { step: 2, title: 'ดริปกาแฟอย่างประณีต', instruction: 'บลูมมิ่งกาแฟ 30 วินาที ค่อยๆ เทน้ำวนเป็นก้นหอย 3 รอบ', durationMinutes: 10 },
          { step: 3, title: 'จิบและชิมรสสัมผัส', instruction: 'รับรู้รสสัมผัส Floral, Fruity และความหวานธรรมชาติของกาแฟ', durationMinutes: 5 },
        ],
        isActive: true,
      ...
      {
        id: 'act-16',
        title: 'Keyboard Melodies & Chords Practice',
        titleTh: 'ฝึกเล่นเปียโน/คีย์บอร์ดเพลงบรรเลง',
        categoryId: 'cat-music',
        description: 'ฝึกไล่นิ้วมือตามสเกล และเล่นท่อนคอร์ดเพลงโปรด ช่วยพัฒนาสมองซีกซ้ายและขวาพร้อมกัน',
        durationMinutes: 35,
        energyLevel: 'medium',
        equipment: ['คีย์บอร์ดไฟฟ้า หรือเปียโน', 'โน้ตเพลงระดับเริ่มต้น', 'หูฟังเพื่อสมาธิ'],
        steps: [
          { step: 1, title: 'วอร์มนิ้วสเกล C Major', instruction: 'เล่นมือขวาและซ้ายแยกกันเพื่อความคล่องตัว', durationMinutes: 8 },
          { step: 2, title: 'ซ้อมท่อนคอร์ดและเมโลดี้', instruction: 'ฝึกจับจังหวะช้าๆ ตามเมโทรนอม', durationMinutes: 20 },
          { step: 3, title: 'บรรเลงทั้งเพลงแบบต่อเนื่อง', instruction: 'เล่นเพลงตั้งแต่ต้นจนจบอย่างผ่อนคลาย', durationMinutes: 7 },
        ],
        isActive: true,
        createdAt: new Date(Date.now() - 2 * 86400000).toISOString(),
        updatedAt: new Date().toISOString(),
      ...
      {
        id: 'act-17',
        title: 'Minimalist Desk Declutter & Reset',
        titleTh: 'จัดโต๊ะทำงานสไตล์มินิมอลเคลียร์สมอง',
        categoryId: 'cat-hobbies',
        description: 'จัดระเบียบพื้นที่โต๊ะทำงาน เก็บสายไฟ เช็ดฝุ่น เพิ่มพื้นที่ว่าง ช่วยลดความเครียดทางสายตา',
        durationMinutes: 25,
        energyLevel: 'medium',
        equipment: ['ผ้าไมโครไฟเบอร์', 'ที่รัดสายไฟ', 'กล่องเก็บของกระจุกกระจิก'],
        steps: [
          { step: 1, title: 'เคลียร์สิ่งของออกจากโต๊ะทั้งหมด', instruction: 'แยกสิ่งจำเป็นกับสิ่งที่ไม่ค่อยได้ใช้', durationMinutes: 6 },
          { step: 2, title: 'เช็ดทำความสะอาดพื้นผิวโต๊ะและหน้าจอ', instruction: 'ทำความสะอาดคีย์บอร์ด เมาส์ และแผ่นรองเมาส์', durationMinutes: 10 },
          { step: 3, title: 'จัดวางเฉพาะสิ่งของที่ใช้บ่อย', instruction: 'วางโคมไฟ ต้นไม้จิ๋ว และสมุดจดอย่างสวยงามลงตัว', durationMinutes: 9 },
        ],
        isActive: true,
        createdAt: new Date(Date.now() - 2 * 86400000).toISOString(),
        updatedAt: new Date().toISOString(),
      ...
      {
        id: 'act-18',
        title: 'AI Exploration & Smart Prompting',
        titleTh: 'ทดลองสร้างไอเดียด้วย AI Prompting',
        categoryId: 'cat-technology',
        description: 'เรียนรู้การป้อนคำสั่ง Prompt เพื่อให้ AI ช่วยสรุปเนื้อหา เขียนโครงร่างบทความ หรือแต่งกลอน',
        durationMinutes: 30,
        energyLevel: 'medium',
        equipment: ['คอมพิวเตอร์หรือแท็บเล็ต', 'การเชื่อมต่ออินเทอร์เน็ต'],
        steps: [
          { step: 1, title: 'กำหนดโจทย์ที่ต้องการสร้าง', instruction: 'เลือกหัวข้อ เช่น วางแผนท่องเที่ยว หรือคิดไอเดียเมนูอาหาร', durationMinutes: 5 },
          { step: 2, title: 'ทดลองเขียน Prompt แบบระบุบริบทชัดเจน', instruction: 'ใส่ Role, Task, Format และข้อจำกัดเพื่อดูผลลัพธ์ที่ดีที่สุด', durationMinutes: 18 },
          { step: 3, title: 'บันทึกสูตร Prompt เด็ดๆ เก็บไว้', instruction: 'รวบรวม Template คำสั่งที่ใช้งานได้ผลดี', durationMinutes: 7 },
        ],
        isActive: true,
        createdAt: new Date(Date.now() - 2 * 86400000).toISOString(),
        updatedAt: new Date().toISOString(),
      ...
      {
        id: 'act-19',
        title: 'Scenic Evening Cycling Route',
        titleTh: 'ปั่นจักรยานรับลมชมวิวช่วงเย็น',
        categoryId: 'cat-health',
        description: 'รับลมยามเย็น สูดอากาศสบายๆ เสริมความฟิตของหัวใจและกล้ามเนื้อขาในเส้นทางสวนสาธารณะ',
        durationMinutes: 45,
        energyLevel: 'high',
        equipment: ['จักรยาน', 'หมวกนิรภัยสำหรับปั่น', 'ไฟส่องสว่างหน้า-หลัง', 'ขวดน้ำ'],
        steps: [
          { step: 1, title: 'ตรวจเช็คลมยางและเบรก', instruction: 'ตรวจความดันลมยางและเช็คเบรกทั้งสองข้างเพื่อความปลอดภัย', durationMinutes: 5 },
          { step: 2, title: 'ปั่นจักรยานตามเส้นทางสวน', instruction: 'รักษาความเร็วปานกลาง ชมนกชมไม้และพระอาทิตย์ตก', durationMinutes: 35 },
          { step: 3, title: 'ยืดเหยียดขาก่อนกลับบ้าน', instruction: 'ยืดกล้ามเนื้อต้นขาด้านหน้าและน่องเพื่อคลายความเมื่อย', durationMinutes: 5 },
        ],
        isActive: true,
      ...
      },
      {
        ...
        titleTh: 'วาดภาพสีน้ำวิวทิวทัศน์สบายตา',
        categoryId: 'cat-art',
        description: 'ใช้เทคนิคเปียกบนเปียก (Wet-on-wet) ระบายท้องฟ้าและทุ่งหญ้า ปลดปล่อยอารมณ์ไปกับน้ำและเม็ดสี',
        durationMinutes: 45,
        energyLevel: 'low',
        equipment: ['กระดาษสีน้ำ 300 แกรม', 'ชุดสีน้ำ 12 สี', 'พู่กันกลมเบอร์ 6 และ 10', 'แก้วน้ำ'],
        steps: [
          { step: 1, title: 'ลงน้ำบนกระดาษและระบายท้องฟ้า', instruction: 'แตะสีฟ้าและม่วงอ่อนปล่อยให้กระจายตัวตามน้ำ', durationMinutes: 12 },
          { step: 2, title: 'แต่งแต้มทิวเขาและต้นไม้', instruction: 'ใช้สีเขียวขี้ม้าและน้ำตาลแตะรูปทรงต้นไม้ระยะไกล', durationMinutes: 23 },
          { step: 3, title: 'เติมรายละเอียดใบไม้ด้านหน้า', instruction: 'ใช้ปลายพู่กันสะบัดหญ้าและลงชื่อผลงานชิ้นเอก', durationMinutes: 10 },
        ],
        isActive: true,
        createdAt: new Date(Date.now() - 1 * 86400000).toISOString(),
        updatedAt: new Date().toISOString(),
      ...
      {
        id: 'act-21',
        title: 'Spaced Repetition Memory Drill',
        titleTh: 'ฝึกจำศัพท์ด้วยเทคนิค Spaced Repetition',
        categoryId: 'cat-language',
        description: 'ทบทวนคำศัพท์ภาษาอังกฤษหรือภาษาญี่ปุ่นด้วยการเว้นระยะความจำ ป้องกันการลืมอย่างเป็นวิทยาศาสตร์',
        durationMinutes: 20,
        energyLevel: 'low',
        equipment: ['แอป Flashcard เช่น Anki หรือกระดาษจดการ์ด', 'ปากกาเน้นข้อความ'],
        steps: [
          { step: 1, title: 'เปิดการ์ดทบทวนคำศัพท์ชุดประจำวัน', instruction: 'ดูคำศัพท์และนึกความหมายก่อนคลิกเฉลย', durationMinutes: 10 },
          { step: 2, title: 'แต่งประโยคใหม่กับคำที่ตอบผิด', instruction: 'เขียนประโยคสั้นๆ เพื่อให้จำบริบทได้แม่นยำ', durationMinutes: 7 },
          { step: 3, title: 'บันทึกสถิติความจำวันนี้', instruction: 'ชื่นชมตนเองที่รักษาวินัยการท่องศัพท์ต่อเนื่อง', durationMinutes: 3 },
        ],
        isActive: true,
        createdAt: new Date(Date.now() - 1 * 86400000).toISOString(),
        updatedAt: new Date().toISOString(),
      ...
      {
        id: 'act-22',
        title: 'Microgreens & Sprout Growing',
        titleTh: 'เพาะต้นอ่อนทานตะวันและผักไมโครกรีน',
        categoryId: 'cat-nature',
        description: 'ปลูกผักต้นอ่อนทานตะวันหรือโต้วเหมี่ยว เก็บเกี่ยวได้ใน 7 วัน ได้ทั้งความเพลิดเพลินและอาหารปลอดสารพิษ',
        durationMinutes: 25,
        energyLevel: 'low',
        equipment: ['เมล็ดทานตะวันสำหรับเพาะ', 'ถาดเพาะและขุยมะพร้าว/ดิน', 'กระบอกฉีดน้ำ Foggy'],
        steps: [
          { step: 1, title: 'แช่เมล็ดในน้ำอุ่น', instruction: 'แช่เมล็ดไว้ 6-8 ชม. หรือตรวจสอบความพร้อมของเมล็ด', durationMinutes: 5 },
          { step: 2, title: 'โรยเมล็ดลงบนดินเพาะ', instruction: 'เกลี่ยเมล็ดให้กระจายทั่วถาด ไม่ทับซ้อนกันหนาเกินไป', durationMinutes: 12 },
          { step: 3, title: 'พรมน้ำชุ่มฉ่ำและคลุมผ้าดำ', instruction: 'ฉีดน้ำให้ทั่ว ปิดถาดไว้ 2 วันแรกเพื่อให้รากงอกแข็งแรง', durationMinutes: 8 },
        ],
        isActive: true,
        createdAt: new Date(Date.now() - 1 * 86400000).toISOString(),
        updatedAt: new Date().toISOString(),
      },
      {
        ...
        titleTh: 'อบคุกกี้ช็อกโกแลตชิปโฮมเมดหอมเนย',
        categoryId: 'cat-cooking',
        description: 'ทำคุกกี้ช็อกโกแลตชิปเนื้อหนึบหอมกลิ่นเนยสดแท้ ทำง่าย อบด้วยหม้อทอดไร้น้ำมันหรือเตาอบ',
        durationMinutes: 50,
        energyLevel: 'medium',
        equipment: ['แป้งสาลี เนยสด น้ำตาลทรายแดง ไข่ไก่ ช็อกโกแลตชิป', 'ชามผสมและพายยาง', 'หม้อทอดไร้น้ำมันหรือเตาอบ'],
        steps: [
          { step: 1, title: 'ตีเนยกับน้ำตาลและผสมแป้ง', instruction: 'คนเนยอุณหภูมิห้องกับน้ำตาลจนเนียน ใส่แป้งและช็อกโกแลตชิป', durationMinutes: 15 },
          { step: 2, title: 'ปั้นเป็นก้อนกลมและแช่พักโด', instruction: 'ตักแป้งคุกกี้เรียงบนกระดาษไข แช่เย็น 15 นาทีให้ทรงตัว', durationMinutes: 15 },
          { step: 3, title: 'อบด้วยความร้อน 165°C', instruction: 'อบนาน 12-15 นาทีจนขอบเป็นสีทอง หอมกรุ่นทั่วบ้าน', durationMinutes: 20 },
        ],
        isActive: true,
        createdAt: new Date(Date.now() - 1 * 86400000).toISOString(),
        updatedAt: new Date().toISOString(),
      ...
      {
        id: 'act-24',
        title: 'Zone 2 Fat Burn Running Session',
        titleTh: 'วิ่งจ็อกกิ้ง Zone 2 เผาผลาญไขมัน',
        categoryId: 'cat-health',
        description: 'วิ่งเหยาะๆ ช้าๆ ในระดับชีพจรที่ยังพูดคุยเป็นประโยคได้สบาย ช่วยเสริมสร้างหลอดเลือดหัวใจและเบิร์นไขมัน',
        durationMinutes: 40,
        energyLevel: 'high',
        equipment: ['รองเท้าวิ่งที่รองรับแรงกระแทก', 'สมาร์ตวอทช์วัดอัตราการเต้นหัวใจ', 'เสื้อผ้าโปร่งสบาย'],
        steps: [
          { step: 1, title: 'วอร์มอัพและจ็อกกิ้งเบาๆ', instruction: 'ก้าวเท้าสั้นๆ ยกเข่าต่ำ หายใจเข้า-ออกทางจมูกเป็นหลัก', durationMinutes: 8 },
          { step: 2, title: 'รักษาระดับความเร็ว Zone 2 สม่ำเสมอ', instruction: 'ควบคุมอัตราการเต้นหัวใจไม่ให้เหนื่อยหอบเกินไป 25 นาที', durationMinutes: 25 },
          { step: 3, title: 'เดินคลายกรดแลคติกและยืดกล้ามเนื้อ', instruction: 'เดินชะลอ 4 นาทีแล้วยืดเอ็นร้อยหวายและสะโพก', durationMinutes: 7 },
        ],
        isActive: true,
        createdAt: new Date(Date.now() - 1 * 86400000).toISOString(),
        updatedAt: new Date().toISOString(),
      },
      {
        ...
        titleTh: 'เดินถ่ายภาพสตรีทจับแสงและเงา',
        categoryId: 'cat-art',
        description: 'ออกไปสำรวจซอยหรือตลาดใกล้บ้าน ถ่ายภาพวิถีชีวิตผู้คน สถาปัตยกรรม แสงสะท้อน และมุมมองแปลกใหม่',
        durationMinutes: 45,
        energyLevel: 'medium',
        equipment: ['สมาร์ตโฟนหรือกล้องขนาดกะทัดรัด', 'รองเท้าผ้าใบเดินสบาย'],
        steps: [
          { step: 1, title: 'สังเกตทิศทางของแสงแดดธรรมชาติ', instruction: 'มองหาแสงเฉียง แสงตกกระทบ และเงาที่สร้างมิติ', durationMinutes: 10 },
          { step: 2, title: 'กดชัตเตอร์จังหวะ Candid Moment', instruction: 'จับภาพอารมณ์ รอยยิ้ม หรือรูปทรงเรขาคณิตของตึกรามบ้านช่อง', durationMinutes: 25 },
          { step: 3, title: 'คัดเลือก 3 ภาพที่ดีที่สุดและปรับโทนสี', instruction: 'ครอปภาพและแต่งแสงเล็กน้อยเพื่อเล่าเรื่องราว', durationMinutes: 10 },
        ],
        isActive: true,
        createdAt: new Date(Date.now() - 1 * 86400000).toISOString(),
        updatedAt: new Date().toISOString(),
      ...
      {
        id: 'act-26',
        title: 'Deep Ocean Documentary Stream',
        titleTh: 'ดูสารคดีสัตว์โลกใต้ทะเลลึก 4K',
        categoryId: 'cat-entertainment',
        description: 'พักผ่อนสายตาและเปิดโลกกว้างกับภาพสิ่งมีชีวิตใต้ทะเลลึกที่งดงาม เสียงบรรยายอันเงียบสงบชวนผ่อนคลาย',
        durationMinutes: 45,
        energyLevel: 'low',
        equipment: ['จอโทรทัศน์หรือแท็บเล็ตความละเอียดสูง', 'เครื่องเสียงหรือหูฟัง', 'หมอนนุ่มๆ'],
        steps: [
          { step: 1, title: 'ปรับแสงไฟห้องให้สลัวสบายตา', instruction: 'ปิดไฟดวงหลัก เปิดโคมไฟสีส้ม Warm Light สบายตา', durationMinutes: 3 },
          { step: 2, title: 'ชมสารคดีสัตว์น้ำและการเรืองแสงใต้ทะเล', instruction: 'สังเกตความมหัศจรรย์ของธรรมชาติและสัตว์น้ำหายาก', durationMinutes: 38 },
          { step: 3, title: 'ยืดเหยียดตัวและดื่มน้ำเปล่า', instruction: 'ผ่อนคลายกล้ามเนื้อคอ บ่า พร้อมเตรียมตัวเข้านอน', durationMinutes: 4 },
        ],
        isActive: true,
        createdAt: new Date(Date.now() - 1 * 86400000).toISOString(),
        updatedAt: new Date().toISOString(),
      ...
      {
        id: 'act-27',
        title: 'Interactive Frontend Mini-Widget',
        titleTh: 'เขียนมินิโปรเจกต์โค้ดดิ้ง React Interactive',
        categoryId: 'cat-technology',
        description: 'ฝึกฝนเขียนคอมโพเนนต์ React สวยๆ เช่น เครื่องมือนับถอยหลัง ตัวคำนวณ หรือเกมตอบคำถามสั้นๆ',
        durationMinutes: 55,
        energyLevel: 'high',
        equipment: ['คอมพิวเตอร์พร้อมเครื่องมือเขียนโค้ด', 'สมุดโน้ตร่าง UI'],
        steps: [
          { step: 1, title: 'ออกแบบ State และ Layout บนกระดาษ', instruction: 'กำหนด Props, Event Handlers และ UI Wireframe', durationMinutes: 10 },
          { step: 2, title: 'เขียน JSX และตกแต่งด้วย Tailwind CSS', instruction: 'ประกอบชิ้นส่วนคอมโพเนนต์และเชื่อมโยง State ให้ทำงาน', durationMinutes: 35 },
          { step: 3, title: 'ทดสอบ Interaction และ Clean Code', instruction: 'ทดสอบกดคลิกทุกปุ่ม ตรวจสอบความถูกต้องและจัด Format', durationMinutes: 10 },
        ],
        isActive: true,
      ...
      {
        id: 'act-28',
        title: 'Mindful Herbal Tea Tasting & Scent Meditation',
        titleTh: 'จิบชาสมุนไพรและฝึกสติรับรู้กลิ่นอโรมา',
        categoryId: 'cat-entertainment',
        description: 'ชงชาคาโมมายล์หรือเปปเปอร์มินต์อุ่นๆ สัมผัสไออุ่น กลิ่นหอม ละเลียดรสชาติ ช่วยผ่อนคลายกล้ามเนื้อและความตึงเครียด',
        durationMinutes: 15,
        energyLevel: 'low',
        equipment: ['ใบชาหรือชาซองสมุนไพร', 'กาน้ำร้อนและแก้วเซรามิก', 'ช้อนคน'],
        steps: [
          { step: 1, title: 'ต้มน้ำและรินน้ำร้อนใส่แก้ว', instruction: 'ใช้น้ำร้อนอุณหภูมิประมาณ 85-90°C แช่ชา 3-5 นาที', durationMinutes: 5 },
          { step: 2, title: 'หลับตาและดมกลิ่นอายสมุนไพร', instruction: 'สูดหายใจลึกๆ รับรู้กลิ่นหอมธรรมชาติ คลายความกังวล', durationMinutes: 5 },
          { step: 3, title: 'ค่อยๆ จิบชาทีละอึกอย่างมีสติ', instruction: 'สังเกตอุณหภูมิและรสหวานธรรมชาติที่ปลายลิ้น', durationMinutes: 5 },
        ],
        isActive: true,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      ...
      {
        id: 'act-29',
        title: 'Jump Rope Cardio Interval Burn',
        titleTh: 'กระโดดเชือกคาร์ดิโอเผาผลาญพลังงานแบบ HIIT',
        categoryId: 'cat-health',
        description: 'เบิร์นไขมันเร่งด่วน เพิ่มความทนทานของกล้ามเนื้อน่องและหัวใจด้วยเซ็ตกระโดดเชือกสลับพัก',
        durationMinutes: 20,
        energyLevel: 'high',
        equipment: ['เชือกกระโดดปรับระดับได้', 'รองเท้ากีฬาซับแรงกระแทก', 'ผ้ารองหรือเสื่อ'],
        steps: [
          { step: 1, title: 'วอร์มอัพข้อเท้าและข้อมือ', instruction: 'หมุนข้อเท้าและยืดเอ็นร้อยหวายป้องกันการบาดเจ็บ', durationMinutes: 3 },
          { step: 2, title: 'กระโดดเชือกสไตล์ Tabata', instruction: 'กระโดดเร็ว 45 วินาที สลับพัก 15 วินาที จำนวน 8-10 รอบ', durationMinutes: 14 },
          { step: 3, title: 'คูลดาวน์และคลายกล้ามเนื้อน่อง', instruction: 'ยืดเหยียดกล้ามเนื้อน่องและขาด้านหลัง หายใจลึกๆ', durationMinutes: 3 },
        ],
        isActive: true,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      ...
      {
        id: 'act-30',
        title: 'DIY Terrarium Miniature Ecosystem',
        titleTh: 'จัดสวนขวดแก้วระบบปิด Mini Terrarium',
        categoryId: 'cat-nature',
        description: 'สร้างระบบนิเวศจำลองขนาดจิ๋วในโหลแก้วด้วยมอส หินภูเขาไฟ และต้นไม้ไซส์เล็ก เพลิดเพลินกับธรรมชาติในบ้าน',
        durationMinutes: 40,
        energyLevel: 'medium',
        equipment: ['ขวดโหลแก้วใสพร้อมฝา', 'หินภูเขาไฟ ดินปลูก และถ่านคาร์บอน', 'มอสสดและต้นเฟิร์นจิ๋ว', 'ฟอร์เซปคีบ'],
        steps: [
          { step: 1, title: 'เรียงชั้นระบายน้ำและดิน', instruction: 'ใส่หินภูเขาไฟชั้นล่าง ตามด้วยถ่านดูดกลิ่นและดินปลูก', durationMinutes: 10 },
          { step: 2, title: 'จัดวางมอสและต้นไม้เล็ก', instruction: 'ใช้ฟอร์เซปคีบต้นไม้ลงปลูก จัดองค์ประกอบให้มีมิติสูงต่ำ', durationMinutes: 22 },
          { step: 3, title: 'พรมน้ำพอชุ่มและปิดฝา', instruction: 'ฉีดละอองน้ำเบาๆ เช็ดกระจกด้านในให้ใส แล้วปิดฝารักษาความชื้น', durationMinutes: 8 },
        ],
        isActive: true,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      ...
      {
        id: 'act-31',
        title: 'Japanese Origami Paper Crafting',
        titleTh: 'พับกระดาษโอริกามิญี่ปุ่นฝึกสมาธิ',
        categoryId: 'cat-hobbies',
        description: 'พับนกกระเรียน ซากุระ หรือกล่องใส่ของน่ารักจากกระดาษสี ฝึกความประณีตของนิ้วมือและสมาธิที่จดจ่อ',
        durationMinutes: 25,
        energyLevel: 'low',
        equipment: ['กระดาษพับโอริกามิลายสวยงาม', 'ไม้บรรทัดหรือกระดูกพับกระดาษ'],
        steps: [
          { step: 1, title: 'เลือกสีและแบบพับที่ชอบ', instruction: 'เริ่มต้นด้วยแบบคลาสสิก เช่น นกกระเรียนมงคล (Orizuru)', durationMinutes: 3 },
          { step: 2, title: 'พับตามรอยเส้นและมุมอย่างประณีต', instruction: 'กดรีดรอยพับให้คมชัด ค่อยๆ คลี่และซ้อนกลีบกระดาษ', durationMinutes: 18 },
          { step: 3, title: 'ดึงขยายรูปทรงและตกแต่ง', instruction: 'คลี่ปีกนกให้สมดุล หรือจัดวางเป็นของประดับบนโต๊ะทำงาน', durationMinutes: 4 },
        ],
        isActive: true,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      ...
      {
        id: 'act-32',
        title: 'Japanese Matcha Whisking Ceremony',
        titleTh: 'ชงมัทฉะแท้ด้วยแปรงไม้ไผ่ Chasen',
        categoryId: 'cat-cooking',
        description: 'สัมผัสพิธีชงชาเขียวมัทฉะดั้งเดิม ตีผงชาด้วยแปรงไม้ไผ่จนเกิดฟองนุ่มละมุน ให้รสชาติอูมามิแท้',
        durationMinutes: 20,
        energyLevel: 'low',
        equipment: ['ผงมัทฉะเกรดพิธีชงชา (Ceremonial Grade)', 'แปรงตีชาไม้ไผ่ (Chasen)', 'ถ้วยชงชาก้นกว้าง (Chawan)', 'กระชอนกรองผงชา'],
        steps: [
          { step: 1, title: 'ร่อนผงมัทฉะและวอร์มถ้วย', instruction: 'ร่อนผงมัทฉะ 2 กรัมลงในถ้วยเพื่อไม่ให้เป็นก้อน แช่แปรงในน้ำอุ่นให้นิ่ม', durationMinutes: 5 },
          { step: 2, title: 'ตีชาด้วยรูปตัว W อย่างรวดเร็ว', instruction: 'เติมน้ำอุ่น 80°C ประมาณ 60-70ml ใช้ข้อมือสะบัดแปรงจนเป็นฟองละเอียด', durationMinutes: 10 },
          { step: 3, title: 'ลิ้มรสความหอมนุ่มและกลมกล่อม', instruction: 'จิบชาพร้อมสัมผัสฟองนุ่มและความสดชื่นสไตล์ญี่ปุ่นแท้', durationMinutes: 5 },
        ],
        isActive: true,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      ...
      {
        id: 'act-33',
        title: 'Podcasting & Voice Memo Storytelling',
        titleTh: 'อัดพอดแคสต์หรือบันทึกเสียงเล่าเรื่องราว',
        categoryId: 'cat-learning',
        description: 'ฝึกทักษะการสื่อสารและเรียบเรียงความคิด ด้วยการบันทึกเสียงเล่าเรื่องราวที่ประทับใจในความยาว 10 นาที',
        durationMinutes: 30,
        energyLevel: 'medium',
        equipment: ['สมาร์ตโฟนหรือไมโครโฟนบันทึกเสียง', 'หัวข้อเรื่องสั้นๆ 1 เรื่อง', 'หูฟัง'],
        steps: [
          { step: 1, title: 'จดหัวข้อประเด็นหลัก 3 ข้อ', instruction: 'ร่างโครงสร้าง บทนำ จุดพีค และบทสรุปข้อคิด', durationMinutes: 8 },
          { step: 2, title: 'กดบันทึกเสียงและเล่าอย่างเป็นธรรมชาติ', instruction: 'ควบคุมโทนเสียง จังหวะหายใจ และความชัดเจนของคำพูด', durationMinutes: 14 },
          { step: 3, title: 'เปิดฟังย้อนหลังและประเมินตนเอง', instruction: 'ฟังความลื่นไหลและจดโน้ตจุดที่อยากพัฒนาต่อไป', durationMinutes: 8 },
        ],
        isActive: true,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      ...
      {
        id: 'act-34',
        title: 'Ukulele Strumming & Easy Pop Song',
        titleTh: 'ตีคอร์ดอูคูเลเล่เพลงป็อปน่ารัก 4 คอร์ด',
        categoryId: 'cat-music',
        description: 'ฝึกเล่นคอร์ด C, Am, F, G บนอูคูเลเล่ กีตาร์ฮาวายตัวเล็กน่ารัก เพลินใจง่าย เสียงสดใส',
        durationMinutes: 25,
        energyLevel: 'medium',
        equipment: ['อูคูเลเล่สายไนลอน', 'ตารางคอร์ด 4 คอร์ดพื้นฐาน'],
        steps: [
          { step: 1, title: 'ตั้งสาย G-C-E-A และวอร์มนิ้ว', instruction: 'เช็คความตึงสายและจับฟอร์มมือซ้ายให้ไม่ติดเฟรต', durationMinutes: 5 },
          { step: 2, title: 'ฝึกดีดสัดส่วน Down-Down-Up-Up-Down-Up', instruction: 'ซ้อมสลับคอร์ด C -> Am -> F -> G อย่างต่อเนื่อง', durationMinutes: 15 },
          { step: 3, title: 'ร้องและเล่นเพลงโปรด 1 ท่อน', instruction: 'ฮัมเพลงตามจังหวะเพื่อความเพลิดเพลินและผ่อนคลาย', durationMinutes: 5 },
        ],
        isActive: true,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      ...
      {
        id: 'act-35',
        title: 'Digital Calligraphy & Lettering Practice',
        titleTh: 'ฝึกเขียนอักษรวิจิตรดิจิทัล (Digital Calligraphy)',
        categoryId: 'cat-art',
        description: 'ฝึกน้ำหนักการลงเส้นหนักเบา (Thick & Thin strokes) เขียนคำคมหรือตัวอักษรภาษาอังกฤษสไตล์โมเดิร์น',
        durationMinutes: 30,
        energyLevel: 'low',
        equipment: ['แท็บเล็ตพร้อมปากกาสไตลัส หรือ ปากกาพู่กัน Brush Pen', 'แอปวาดรูปหรือสมุดตารางฝึกเส้น'],
        steps: [
          { step: 1, title: 'ฝึกเส้นขึ้นเบา เส้นลงหนัก (Up thin, Down thick)', instruction: 'วอร์มลากเส้นซิกแซกและวงรีเพื่อจับน้ำหนักมือ', durationMinutes: 8 },
          { step: 2, title: 'เขียนตัวอักษรเป็นคำสั้นๆ เช่น "Peace" หรือ "Focus"', instruction: 'เชื่อมต่อตัวอักษรอย่างอ่อนช้อยและสมดุล', durationMinutes: 16 },
          { step: 3, title: 'เติมเงาและตกแต่งขอบอักษร', instruction: 'เพิ่มไฮไลต์สีขาวหรือเงาสีพาสเทลให้ข้อความโดดเด่น', durationMinutes: 6 },
        ],
        isActive: true,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      ...
      {
        id: 'act-36',
        title: 'Daily News Podcast Listening & Shadowing',
        titleTh: 'ฝึกฟังข่าวภาษาอังกฤษสากลพร้อมพูดตาม (Shadowing)',
        categoryId: 'cat-language',
        description: 'ฟังพอดแคสต์ข่าวสั้นระดับโลก 6-10 นาที แล้วพูดเลียนแบบจังหวะการออกเสียงของเจ้าของภาษาทันที',
        durationMinutes: 25,
        energyLevel: 'medium',
        equipment: ['แอปพอดแคสต์ (เช่น BBC 6 Minute English หรือ NPR)', 'หูฟัง', 'สมุดจดสำนวนเด่น'],
        steps: [
          { step: 1, title: 'ฟังเนื้อหาข่าวรอบแรกเพื่อจับใจความ', instruction: 'ทำความเข้าใจประเด็นหลักโดยไม่ต้องหยุดเสียง', durationMinutes: 7 },
          { step: 2, title: 'เปิดสคริปต์และฝึกพูดตาม (Shadowing)', instruction: 'ออกเสียงเลียนแบบสำเนียงและน้ำเสียงสูงต่ำอย่างเป็นธรรมชาติ', durationMinutes: 12 },
          { step: 3, title: 'จดบันทึก 3 สำนวนน่าใช้', instruction: 'นำสำนวนที่ได้ยินไปแต่งประโยคในบริบทชีวิตประจำวัน', durationMinutes: 6 },
        ],
        isActive: true,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      ...
      {
        id: 'act-37',
        title: 'Build a Terminal Command-Line Tool in Node.js',
        titleTh: 'สร้างโปรแกรมคำสั่ง CLI ด้วย Node.js',
        categoryId: 'cat-technology',
        description: 'เขียนสคริปต์สั้นๆ ในเทอร์มินัลเพื่อคำนวณภาษี สุ่มไอเดีย หรือดึงข้อมูลสภาพอากาศ ใช้งานได้จริงบนคอมพิวเตอร์',
        durationMinutes: 45,
        energyLevel: 'high',
        equipment: ['คอมพิวเตอร์พร้อม Node.js', 'Visual Studio Code / Terminal'],
        steps: [
          { step: 1, title: 'กำหนดคำสั่งและ Argument รับค่า', instruction: 'ออกแบบรูปแบบคำสั่ง เช่น node cli.js --task calculate', durationMinutes: 10 },
          { step: 2, title: 'เขียนโค้ดตรรกะประมวลผลและการแสดงผลสี', instruction: 'ใช้ process.argv หรือไลบรารี CLI เพื่อจัดรูปแบบข้อความ', durationMinutes: 25 },
          { step: 3, title: 'ทดสอบรันคำสั่งบน Terminal', instruction: 'รันคำสั่งจริงพร้อมตรวจสอบการจัดการข้อผิดพลาด (Error handling)', durationMinutes: 10 },
        ],
        isActive: true,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
    ...
    const users: User[] = [
      ...
      {
        id: 'usr-admin-chalinrat',
        email: 'chalinrat15@gmail.com',
        passwordHash: '123456',
        fullName: 'Chalinrat (ผู้ดูแลระบบ)',
        role: 'admin',
        status: 'active',
        avatarUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80',
        interests: ['Learning', 'Technology & Coding', 'Health & Fitness'],
